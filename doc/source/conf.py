...
try:
    import schiirdor
    import schiirdor.__pkginfo__ as release_info
except ImportError:
    raise RuntimeError("Cannot import 'schiirdor', please investigate.")
...
html_title = "SCHIIRDOR"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "SCHIIRDOR"
...
htmlhelp_basename = 'schiirdor-doc'
...
latex_documents = [
  ('index', 'schiirdor.tex', u'Population Imaging Web Service Documentation',
   u'Grigis', 'manual'),
]
